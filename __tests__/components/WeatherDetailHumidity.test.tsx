...
import WeatherDetailHumidity from "@/components/WeatherDetailHumidity";
...
describe("Humidity", () => {
  it("renders the time for that block", () => {
    render(
      <AllTheProviders>
        <WeatherDetailHumidity day={0} data={data} />
      </AllTheProviders>
    );
  ...
  it("renders the humidity for that block", () => {
    render(
      <AllTheProviders>
        <WeatherDetailHumidity day={0} data={data} />
      </AllTheProviders>
  ...
  it("renders the humidity for that block", () => {
    ...
    const day = screen.queryByText("88");
  ...
  it("renders the humidity for that block", () => {
    ...
    const day = screen.queryByText("903840372759238709487598712387548372");
  ...
  it("renders the humidity for that block", () => {
    ...
    const day = screen.queryByText("90");
  ...
  it("renders the humidity for that block", () => {
    ...
    const word = screen.queryByText("word");
